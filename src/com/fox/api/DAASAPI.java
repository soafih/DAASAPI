...
public class DAASAPI {
	...
	public Response generateService(DaasAPIRequest request) throws ClientProtocolException, IOException, JSONException {
		...
		try {
			 ...
			 * 
			 * // do something useful with the response body // and ensure it is
			 * fully consumed if (response2.getStatusLine().getStatusCode() !=
			 * 201) { throw new RuntimeException("Failed : HTTP error code : " +
			 * response2.getStatusLine().getStatusCode()); }
			 * 
			 * 
			 * 
			 * String output; System.out.println("HI"); System.out.println(
			 * "Output from Server .... \n"); BufferedReader br = new
			 * BufferedReader( new
			 * InputStreamReader((response2.getEntity().getContent()))); while
